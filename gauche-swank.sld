...
(define-library (gauche-swank)
  ...
  (import (scheme base) (scheme eval) (scheme read) (scheme write) (scheme file) (scheme case-lambda) (scheme process-context) (scheme repl) (scheme load) (scheme char) (scheme cxr)
          ...
          (only (gauche base)
                ...
                ;; for Gauche custom
                define-module global-variable-bound? with-module
  ...
  ;; for Gauche 0.9.9_pre2
  (begin
    (define-module gauche.hashutil)
    (load "gauche/hashutil")
    (define hash-table-for-each
      (if (global-variable-bound? 'gauche.hashutil 'hash-table-for-each)
        (with-module gauche.hashutil hash-table-for-each)
        (with-module gauche hash-table-for-each))))
